    ...
    def postfix_to_prefix(self, postfix_tokens: list) -> list:
        ...
        for token in postfix_tokens:
            if token in self.operators:
                ...
                new_expression = [token] + stack[num_operands:]
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"prefix expression: {converter.list_to_str(prefix_tokens)}")
        print(f"postfix expression: {converter.list_to_str(postfix_tokens)}")
